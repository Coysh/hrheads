<div class="inner-section number-counter">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="<?php echo $cols; ?> number d-flex" data-wow-delay="<?php echo $i / 3; ?>s"
                data-wow-duration="1.2s">
                <div class="inner dark-blue-bg is-dark float d-flex flex-column">
